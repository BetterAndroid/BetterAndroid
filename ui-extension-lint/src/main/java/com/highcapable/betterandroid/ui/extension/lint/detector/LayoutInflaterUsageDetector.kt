...
class LayoutInflaterUsageDetector : Detector(), Detector.UastScanner {
    ...
    companion object {
        ...
        private const val LAYOUT_INFLATER_CLASS = "android.view.LayoutInflater"
        private const val FROM_METHOD = "from"
        private const val LAYOUT_INFLATER_PROPERTY = "layoutInflater"
        ...
        val ISSUE = Issue.create(
            ...
            implementation = Implementation(
                LayoutInflaterUsageDetector::class.java,
        ...
        override fun visitCallExpression(node: UCallExpression) {
            ...
            context.report(
                ...
                quickfixData = buildReplaceFix(
                    ...
                    imports = arrayOf("${DeclaredSymbol.VIEW_PACKAGE}.$LAYOUT_INFLATER_PROPERTY")
                )
            )
        }
    }
