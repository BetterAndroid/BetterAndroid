...
| [ReplaceWithNotificationAction](repo://tree/main/ui-component-lint/src/main/java/com/highcapable/betterandroid/ui/component/lint/detector/NotificationActionUsageDetector.kt)                         | `USABILITY`   | `WARNING` | `5`      | Use ui-component's notification action APIs instead          |
...
| Issue ID                                                                                                                                                                         | Category    | Severity  | Priority | Brief Description                                                                |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------- | -------- | -------------------------------------------------------------------------------- |
| [ReplaceWithAndroidVersion](repo://tree/main/system-extension-lint/src/main/java/com/highcapable/betterandroid/system/extension/lint/detector/AndroidVersionUsageDetector.kt)    | `USABILITY` | `WARNING` | `5`      | Use system-extension's `AndroidVersion` instead of direct `Build.VERSION` access |
